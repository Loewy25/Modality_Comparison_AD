...
class ModelBuilder:
    ...
    def create_model(self, dropout_rate=0.2, l2_reg=4.12680083238248e-06, reduction_ratio=10):
...
class Trainer:
    ...
    def train_model(self, X, Y):
        ...
        for fold_num, (train_idx, val_idx) in enumerate(stratified_kfold.split(X, Y.argmax(axis=1))):
            ...
            model.compile(optimizer=Adam(learning_rate=0.00014504886334615907),
