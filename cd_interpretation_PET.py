...
average_single_weights,average_corrected_weights,average_permuted_single_weights,average_permuted_corrected_weights=nested_crossvalidation_multi_kernel(image,label1,[30],5,3,1000)
