...
class CNNModel:
    ...
    def create_model(input_shape=(128, 128, 128, 1), num_classes=2, dropout_rate=0.05, l2_reg=1e-5, reduction_ratio = 8):
        ...
        x = CNNModel.convolution_block(x, 64, strides=(2, 2, 2), l2_reg=l2_reg, use_cbam=False)
        conv3_out = x
        x = CNNModel.context_module(x, 64, dropout_rate=dropout_rate, l2_reg=l2_reg, use_cbam=False)
        x = Add()([x, conv3_out])
        ...
        x = CNNModel.convolution_block(x, 256, strides=(2, 2, 2), l2_reg=l2_reg, use_cbam=False)
        conv5_out = x
        x = CNNModel.context_module(x, 256, dropout_rate=dropout_rate, l2_reg=l2_reg, use_cbam=False)
        x = Add()([x, conv5_out])
...
def main():
    ...
    info = 'cbam_v5'  # Additional info for saving results
