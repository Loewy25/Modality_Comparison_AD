...
performance_dict_mri,all_y_test_mri, all_y_prob_mri, all_predictions_mri=nested_crossvalidation(reduced_data, label, 'early-z', 'cd')
...
# Run your function (replace with actual arguments)
performance_dict_mri,all_y_test_mri, all_y_prob_mri, all_predictions_mri=nested_crossvalidation(reduced_data, label, 'early-z', 'cm')
end_time = time.time()  # Capture end time
...
# Run your function (replace with actual arguments)
performance_dict_mri,all_y_test_mri, all_y_prob_mri, all_predictions_mri=nested_crossvalidation(reduced_data, label, 'early-z', 'dm')
end_time = time.time()  # Capture end time
...
# Run your function (replace with actual arguments)
performance_dict_mri,all_y_test_mri, all_y_prob_mri, all_predictions_mri=nested_crossvalidation(reduced_data, label, 'early-z', 'pc')
end_time = time.time()  # Capture end time
